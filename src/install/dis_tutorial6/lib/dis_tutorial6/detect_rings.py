...
class RingDetector(Node):
    ...
    def depth_callback(self, data):
        ...
        cv2.imshow("Depth Image", depth_image_visualization)
        ...
        for image in cut_images:
            ...
            # Create a black image of the same dimensions for drawing valid contours
            valid_contours_image = np.zeros_like(image)
            # Example of how to draw the contours, only for visualization purposes
            ...
            if len(valid_contours)>0:
                ...
                cv2.drawContours(valid_contours_image, valid_contours, -1, (255, 255, 255), 3)
                # Display the image with valid contours only
                cv2.imshow("Valid Contours", valid_contours_image)
